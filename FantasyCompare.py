...
st.set_page_config(page_title="NFL dataset", layout="wide", page_icon="C:\\Users\\gavin\\Documents\\Coding\\Data\\NFL\\JJGH.jpeg")

st.title("NFL Fantasy Player Comparison App")
st.write("This app will help you analyze NFL data effectively.")


def load_data():
    data1=pd.read_csv('C:\\Users\\gavin\\Documents\\Coding\\Data\\NFL\\stats_player_week_2020.csv')
    data2=pd.read_csv('C:\\Users\\gavin\\Documents\\Coding\\Data\\NFL\\stats_player_week_2021.csv')
    data3=pd.read_csv('C:\\Users\\gavin\\Documents\\Coding\\Data\\NFL\\stats_player_week_2022.csv')
    data4=pd.read_csv('C:\\Users\\gavin\\Documents\\Coding\\Data\\NFL\\stats_player_week_2023.csv')
    data5=pd.read_csv('C:\\Users\\gavin\\Documents\\Coding\\Data\\NFL\\stats_player_week_2024.csv')
    data6=pd.read_csv('C:\\Users\\gavin\\Documents\\Coding\\Data\\NFL\\stats_player_week_2025.csv')
...
years = st.slider("Season", 2020, 2025, (2024, 2025))
week = st.slider("Week", 1, 22, (1, 18))
...
st.image("C:\\Users\\gavin\\Documents\\Coding\\Data\\NFL\\JJGH.jpeg", width=100)